...
const NARRATIVE = {
  ...
  "steps": [
...

    {
      ...
      "resume": "La villa est saturée d'indices sur la disparition de la famille Paterson, sur Nellie Bly (qui y a vécu clandestinement) et sur les recherches d'Alexeï Fedorov. Utilisez l'aide de jeu n°1 (tableau des indices) pour cocher au fur et à mesure ce qui a été découvert (D) et utilisé (U).",
      "chapitres": [
            {
                  "titre": "Villa Paterson",
                  "type": "lieu"
            },
            {
                  "titre": "Arrivée",
                  "blocs": [
                        {
                              "type": "vert",
                              "contenu": "La bâtisse est orientée perpendiculairement à la rue. On y accède via une petite cour rectangulaire par l'allée de gravier blanc. Face à la maison, une sorte de petit hangar ouvert permet d'abriter une carriole ou une automobile. Il n'y a pas de véhicule garé. Une volée de marches mène à une porte peinte en vert foncé. Sur la droite pend une chaîne reliée à une petite clochette."
                        },
                        {
                              "type": "neutre",
                              "contenu": "La maison est une belle bâtisse bourgeoise assez récente. Elle comporte deux étages, une cave et un grenier. L'arrière donne sur le canal d'Amityville, relié à la grande baie sud."
                        },
                        {
                              "type": "bleu",
                              "contenu": "Les PJ sont seuls devant la porte — personne ne répond à la clochette. La porte est fermée à clef, mais le personnage possédant la clef du singe aveugle peut l'utiliser pour ouvrir.",
                              "label": "🔵 Accès"
                        },
                        {
                              "type": "neutre",
                              "contenu": "Dès qu'un PJ entre, un chat tacheté gris et noir surgit de nulle part et se faufile entre ses jambes, puis se retourne et miaule en direction du personnage. S'il s'approche, le chat ronronne et se frotte contre ses jambes ; si on essaye de l'attraper, il se sauve."
                        },
                        {
                              "type": "bleu",
                              "contenu": "De la poussière s'est accumulée, signe que la maison n'est pas occupée depuis plusieurs semaines. Test de PER difficulté 10 pour remarquer que les chambres 7 à 10 sont encore plus poussiéreuses que le reste — inoccupées depuis bien plus longtemps.",
                              "label": "🔵 Jet de dés"
                        }
                  ]
            },
            {
                  "titre": "1. Hall d'entrée",
                  "blocs": [
                        {
                              "type": "bleu",
                              "contenu": "Dans la table basse, un petit tiroir comporte une clef supplémentaire (tête de singe qui se bouche les oreilles — clef du singe sourd) et une lettre ouverte de James Paterson.",
                              "label": "🔵 Indice n°1"
                        },
                        {
                              "type": "bleu",
                              "contenu": "🔵 Aide de jeu — Vous pouvez donner l'aide de jeu B à vos joueurs. Elle correspond à la lettre de J. Paterson.",
                              "label": "🔵 Aide de jeu"
                        },
                        {
                              "type": "vert",
                              "contenu": "Amityville, le 23 octobre 1920. Chère madame Seaman, vous êtes ici comme chez vous. Vous pouvez utiliser les chambres de droite à votre guise aussi longtemps qu'il vous plaira. Nous pensons rester en Suisse au moins une année. Vous trouverez une seconde clef dans le tiroir de ce meuble. Lana vous présente ses regrets de n'avoir pu vous accueillir en personne. Je ne saurais assez vous remercier de m'avoir ouvert les yeux sur les méthodes détestables du docteur Morrow. Nous vous souhaitons bonne chance dans votre entreprise, prenez soin de vous, restez prudente. Avec toute notre affection. James Paterson"
                        },
                        {
                              "type": "neutre",
                              "contenu": "Conservateur dans l'âme, James Paterson appelle Elizabeth par son nom marital, Elizabeth Seaman — il s'agit bien de Nellie Bly."
                        }
                  ]
            },
            {
                  ...
                  "blocs": [
                        {
                              "type": "vert",
                              "contenu": "Une salle de billard ordinaire et cossue. Des livres de toutes sortes sur les étagères. Une boîte de cigares de qualité. Une petite table à l'entrée."
                        },
                        {
                              "type": "neutre",
                              "contenu": "Sur la petite table, un dépliant publicitaire : « A Cure for Wellness - Dr. Heinrich Volmer Sanatorium - Berghof Castle - Davos, Swiss Alps », avec la photo d'un château dans les montagnes. Cet indice explique simplement le départ de la famille Paterson pour la Suisse — piste secondaire, sans lien direct avec l'enquête en cours."
                        }
                  ]
            },
            {
                  ...
                  "blocs": [
                        {
                              "type": "vert",
                              "contenu": "La cuisine n'a pas servi récemment, mais tout semble avoir été abandonné soudainement. De la vaisselle, des ustensiles de cuisine et quelques produits de première nécessité. Sur la table, un bocal contient un liquide rougeâtre et un livre est ouvert juste à côté."
                        },
                        {
                              "type": "bleu",
                              "contenu": "Indice n°2 — L'hématite : le liquide rouge n'est pas du sang, mais de l'eau teintée par deux morceaux d'hématite (« pierre de sang »). Le livre, un traité sur les minéraux, est ouvert à la page qui décrit cette pierre : dans l'Égypte ancienne, l'hématite servait à soigner les troubles liés au sang, et plongée dans l'eau elle la teinte en rouge — perçue comme une stimulation de la fabrication du sang. Dans la marge, Nellie a noté : « Autel en pierre de sang : s'emparer de leur pouvoir en répandant son sang ? »",
                              "label": "🔵 Indice n°2"
                        }
                  ]
            },
            {
                  "titre": "4. Salle à manger",
                  "blocs": [
                        {
                              "type": "vert",
                              "contenu": "La grande table est recouverte de feuilles agrafées les unes à côté des autres et couvertes de formules mathématiques, de chiffres et de calculs. Posée par-dessus, une lettre."
                        },
                        {
                              "type": "bleu",
                              "contenu": "Indice n°3 — Calculs mathématiques : ces feuilles sont une copie des formules dont le mathématicien fou Alexeï Fedorov couvre les murs de sa cellule à l'asile d'Amityville. Nellie a compris qu'Alexeï n'était pas un patient comme les autres, et recopiait les formules à chaque ménage — sans avoir eu le temps de terminer. Test d'INT difficulté 10 (mathématiques) pour réaliser qu'il en manque une partie. Test d'INT difficulté 20 (un essai par jour) pour comprendre que les formules concernent la déformation de l'espace-temps et un calcul de conjonction planétaire.",
                              "label": "🔵 Indice n°3"
                        },
                        {
                              "type": "bleu",
                              "contenu": "Indice n°4 — Lettre d'Einstein : réponse d'Albert Einstein à une lettre de Nellie, en allemand (test d'INT linguistique difficulté 20 sans traducteur). « Le 22 décembre 1920. Chère madame Bly, [...] les feuillets que vous m'avez envoyés sont incomplets [...] Certaines incohérences dans les calculs de gravité du système pourraient prédire l'existence d'un corps céleste massif que nous n'aurions pas encore détecté. [...] je serai présent à l'université Columbia de New York le 15 avril 1921 [...] Pourriez-vous essayer de m'apporter les feuillets manquants ? [...] Contactez de ma part le professeur Michael Pupin, il organisera notre rencontre. Albert Einstein »",
                              "label": "🔵 Indice n°4"
                        },
                        {
                              "type": "bleu",
                              "contenu": "🔵 Aide de jeu — Vous pouvez donner l'aide de jeu C à vos joueurs. Elle correspond à la lettre d'Einstein.",
                              "label": "🔵 Aide de jeu"
                        },
                        {
                              "type": "neutre",
                              "contenu": "Conclusion de cet indice : les PJ devront s'introduire dans l'asile pour trouver la cellule d'Alexeï et obtenir la suite des calculs, puis rencontrer Einstein à Columbia le 15 avril pour qu'il résolve les équations."
                        },
                        {
                              "type": "bleu",
                              "contenu": "[MJ SEULEMENT] Si un PJ a l'archétype de mathématicien génial, laissez-le travailler lui-même sur les équations plutôt que de passer par Einstein — mais seulement après l'enfermement dans la Villa Paterson (aventure 3), où la nature de leur prison interdimensionnelle lui permettra de voir le problème sous un angle nouveau.",
                              "label": "🔵 Conseil MJ"
                        }
                  ]
            },
            {
                  ...
                  "blocs": [
                        {
                              "type": "vert",
                              "contenu": "Ce grand salon est agrémenté d'une vaste cheminée et de nombreux tableaux ornent les murs. La pièce comporte plusieurs tables, fauteuils ainsi qu'un divan. Un meuble de bois noir rectangulaire et un peu plus haut qu'une table occupe le centre de la pièce. Sur la table basse qui jouxte le divan, vous apercevez une longue pipe destinée à fumer l'opium, une boîte noire et deux livres."
                        },
                        {
                              "type": "neutre",
                              "contenu": "Nellie a profité de l'absence de la famille Paterson pour installer et expérimenter des pratiques occultes que les propriétaires n'auraient pas approuvées : l'armonica de verre et l'opium. La boîte noire décorée d'un dragon contient de quoi fumer une douzaine de pipes — chaque dose suffit à endormir tous les PJ."
                        },
                        {
                              "type": "bleu",
                              "contenu": "Le meuble noir est un armonica de verre — instrument rare (test d'INT musique difficulté 15 pour le reconnaître). Si un PJ en joue (test d'INT difficulté 10), l'instrument émet des notes éthérées qui semblent sortir des murs eux-mêmes, ce qui attire le chat.",
                              "label": "🔵 Indice"
                        },
                        {
                              "type": "neutre",
                              "contenu": "Nellie faisait appel à un musicien français, Robert Denod, pour jouer de l'armonica pendant qu'elle fumait l'opium, afin d'atteindre les Contrées du rêve."
                        },
                        {
                              "type": "bleu",
                              "contenu": "Indice n°5 — Article sur l'armonica : almanach des instruments de musique. Une carte de visite de Robert Denod (professeur de musique, adresse à Brooklyn) marque la page consacrée à l'armonica, avec un avertissement d'époque sur ses effets dépressifs sur les nerfs.",
                              "label": "🔵 Indice n°5"
                        },
                        {
                              "type": "bleu",
                              "contenu": "Indice n°6 — Un livre sur les rêves : théories sur les songes et les Contrées du rêve, un chapitre sur l'armonica qualifié de « porte vers les terres au-delà de la conscience ». Nellie a signalé un paragraphe sur une expérience où quatre enfants d'une fratrie ont partagé un rêve commun. Une mention manuscrite cite le nom de Robert Denod et son adresse à Brooklyn.",
                              "label": "🔵 Indice n°6"
                        },
                        {
                              "type": "bleu",
                              "contenu": "[MJ SEULEMENT] Ne laissez pas les PJ s'installer ailleurs que dans la Villa Paterson pour parcourir les Contrées du rêve — vous avez besoin de les avoir sur place pour l'aventure 3. Robert Denod refuse de travailler ailleurs, persuadé (à raison) qu'il faut rester ici pour retrouver Nellie.",
                              "label": "🔵 Conseil MJ"
                        }
                  ]
            },
            {
                  ...
                  "blocs": [
                        {
                              "type": "neutre",
                              "contenu": "Musicien mélancolique et timide. Il n'ose pas avouer que Nellie le payait pour jouer pendant qu'elle fumait de l'opium (pratique illégale). Il est assez facile de le faire parler si on mentionne la disparition de Nellie, car il s'inquiète pour elle."
                        },
                        {
                              "type": "neutre",
                              "contenu": "Elle lui avait expliqué que sa musique lui permettait de faire des rêves plus réalistes et de visiter des contrées extraordinaires, ce qu'il attribuait à la drogue. Elle cherchait à rêver d'un endroit mystique qu'elle appelait le plateau de Leng. Un jour, elle est revenue très pâle, a simplement dit « Ô mon Dieu, mon Dieu ! » et lui a demandé de partir."
                        },
                        {
                              "type": "bleu",
                              "contenu": "Il n'est pas difficile de convaincre Robert de jouer pour les PJ, même gratuitement. Il joue le dernier morceau interprété pour Nellie : un extrait de l'opéra Die Frau ohne Schatten (La femme sans ombre) de Richard Strauss.",
                              "label": "🔵 Jet de dés"
                        },
                        {
                              "type": "neutre",
                              "contenu": "Dès les premières notes, le chat surgit et se blottit en ronronnant sur les genoux de son PJ préféré. La dernière chose que le PJ voit en fermant les paupières est le regard d'or du félin. Chasser le chat serait une mauvaise idée — sans lui, les PJ se perdraient en un lieu sans rapport avec l'enquête."
                        }
                  ]
            },
            {
                  "titre": "Vers les Contrées du rêve",
                  "blocs": [
                        {
                              "type": "bleu",
                              "contenu": "Test de PER (rêver) difficulté 10 pour chaque PJ (bonus de la Voie des rêves si déjà acquise). Échec = sommeil sans souvenir, réveil une douzaine d'heures plus tard, nauséeux, avec possibilité de retenter plus tard. Une fois réussi une première fois, plus besoin de retester.",
                              "label": "🔵 Jet de dés"
                        },
                        {
                              "type": "vert",
                              "contenu": "Vous plongez dans une douce léthargie, votre esprit quitte votre corps et s'élève dans les cieux. Des océans de couleur émeraude défilent sous vos pieds à toute vitesse. Vous franchissez des cimes si élevées qu'elles semblent toucher le firmament. Vous survolez des cités oubliées aux minarets d'or pur. Enfin vous parvenez à une vaste étendue de pierre jaune éclairée par une lune spectrale. Des canyons et des plateaux tabulaires forment un vaste labyrinthe. Au loin vous apercevez cinq pyramides à cinq faces. Mais bien avant de les atteindre, vous plongez dans une gorge étroite, devant l'entrée d'une grotte ténébreuse. Deux yeux dorés s'ouvrent dans le noir et une voix féminine vous adresse la parole : « Pourquoi êtes-vous ici ? »"
                        },
                        {
                              "type": "bleu",
                              "contenu": "[MJ SEULEMENT] Tant que les PJ n'ont pas vécu la majorité des aventures 1 et 2 (notamment le flash-back qui leur fait retrouver la mémoire), ils ne connaissent pas la bonne réponse. La voix reprend alors : « Revenez lorsque vous aurez la réponse. » Les PJ se réveillent dans la bibliothèque avec une légère migraine, après une douzaine d'heures — Robert Denod dort dans une chambre d'ami en attendant leur réveil.",
                              "label": "🔵 Secret MJ"
                        }
                  ]
            },
            {
                  "titre": "6. Bibliothèque",
                  "blocs": [
                        {
                              "type": "vert",
                              "contenu": "La bibliothèque possède des livres de toutes sortes, notamment l'œuvre intégrale de Jules Verne. Sur la table de lecture, cinq livres et une boîte à photos sont posés, empilés en vrac."
                        },
                        {
                              "type": "neutre",
                              "contenu": "Aux côtés des œuvres de Jules Verne trône un exemplaire de l'ouvrage de Nellie Bly, Le Tour du monde en 72 jours, dédicacé de sa main."
                        }
                  ]
            },
            {
                  "titre": "7. Chambre de Louise",
                  "blocs": [
                        {
                              "type": "vert",
                              "contenu": "La plus grande chambre est celle d'une petite fille. Des dessins d'enfant sont accrochés aux murs. Des banquettes, une petite table, des malles, des boîtes."
                        },
                        {
                              "type": "bleu",
                              "contenu": "Les dessins d'enfant représentent de nombreux singes. Test de PER difficulté 15 pour repérer les trois singes de la sagesse — un œil qui les cherche trouvera aussi une référence à chacun des cinq sens.",
                              "label": "🔵 Jet de dés"
                        },
                        {
                              "type": "bleu",
                              "contenu": "Indice n°9 — Un poème : écrit au crayon noir par Louise, se souvenant partiellement de ses rêves : « Entrés dans mon rêve un jour, Restés dans ma vie toujours. M'ont enlevé une nuit, Pour trouver toutes les clefs Que le singe avait cachées Et puis ils se sont enfuis. Entrez dans mon rêve un jour, Restez dans ma vie toujours. » Ce poème fait référence à l'aventure 3 et trouvera sa signification à ce moment-là.",
                              "label": "🔵 Indice n°9"
                        },
                        {
                              "type": "bleu",
                              "contenu": "Indice n°10 — Un jeu de l'oie : offert par Nellie pour les 8 ans de Louise. En l'ouvrant, les PJ trouvent la clef du singe muet rangée avec les dés et les figurines uniques (une dame en tenue de voyage = Nellie ; une fillette avec un petit singe dans les bras = Louise et sa peluche). Si les PJ tentent d'y jouer, ils ne réussissent jamais à gagner — effet occulte de l'enfermement de Nellie dans la maison repliée.",
                              "label": "🔵 Indice n°10"
                        }
                  ]
            },
            {
                  "titre": "8. Chambre de James Jr.",
                  "blocs": [
                        {
                              "type": "vert",
                              "contenu": "Une chambre de garçon bien rangée. Dans un grand coffre des jouets qui ont plusieurs années : voitures miniatures et faux pistolets en bois."
                        },
                        {
                              "type": "neutre",
                              "contenu": "La chambre du fils aîné n'a pas été occupée depuis plusieurs mois. Les PJ peuvent trouver dans le coffre un gant de base-ball, deux balles et deux battes."
                        }
                  ]
            },
            {
                  "titre": "9. Chambre de Cécilia et 10. Chambre parentale",
                  "blocs": [
                        {
                              "type": "vert",
                              "contenu": "Des dentelles et des napperons en décoration, deux poupées adossées sur les oreillers du lit. Une coiffeuse et dans un coffre des habits de petite fille."
                        },
                        {
                              "type": "neutre",
                              "contenu": "Chambre de Cécilia : aucun indice ici. La chambre parentale est propre et bien rangée."
                        }
                  ]
            }
      ],
      "pnj": [
            {
                  "nom": "Le chat",
                  "desc": "Chat tacheté gris et noir. Attire l'attention des PJ sur un indice manqué, à utiliser avec parcimonie. Indispensable pour rejoindre les Contrées du rêve."
            },
            {
                  "nom": "Robert Denod",
                  "desc": "Musicien mélancolique, jouait de l'armonica de verre pour Nellie. Accepte facilement d'aider les PJ à entrer dans les Contrées du rêve."
            }
      ]
},
    {
      "id": "q1_e3",
      "label": "La chambre de Nellie et l'asile",
      "resume": "La chambre de Nellie Bly, la chambre noire et la cave révèlent les indices les plus importants de la villa : le trousseau de clefs de l'asile, l'article original de Nellie, la liste des patients, et surtout les photographies développées — dont une qui montre l'Homme en noir lui-même.",
      "chapitres": [
            {
                  "titre": "11. Chambre des domestiques et 12. Chambre d'ami",
                  "blocs": [
                        {
                              "type": "vert",
                              "contenu": "Un dortoir de trois lits, autant de malles, un tapis."
                        },
                        {
                              "type": "neutre",
                              "contenu": "Lorsque les Paterson habitent ici, c'est là que logent les domestiques (une cuisinière, une gouvernante et une infirmière pour Louise). Tout a été vidé et le personnel congédié — les PJ peuvent s'y installer, ainsi que dans la chambre d'ami voisine, vide, propre et rangée."
                        }
                  ]
            },
            {
                  "titre": "13. Chambre de Nellie",
                  "blocs": [
                        {
                              "type": "vert",
                              "contenu": "Une malle de voyage avec quelques vêtements de femme en vrac, d'autres disséminés un peu partout. L'occupante de cette chambre semble peu préoccupée par le rangement."
                        },
                        {
                              "type": "neutre",
                              "contenu": "Deux tenues d'employée de l'asile sont posées sur le lit défait : robe noire, tablier et fichu blanc. L'une est propre et repassée, l'autre a été portée — en fouillant ses poches, on trouve un flacon de sels d'ammonium que Nellie utilisait pour réveiller les patients qu'elle voulait interroger, notamment les PJ."
                        },
                        {
                              "type": "bleu",
                              "contenu": "Indice n°11 — Un trousseau de clefs : une clef des cellules (identique pour toutes), une clef de la blanchisserie, une clef des réserves et lingeries. Une clef à part est en réalité un passe (test d'INT crocheter difficulté 15 pour le reconnaître) — reproduction fidèle du passe-partout des docteurs, qui ouvre toutes les portes de l'asile.",
                              "label": "🔵 Indice n°11"
                        },
                        {
                              "type": "bleu",
                              "contenu": "Indice n°12 — Version originale de Ten Days in a Madhouse : la toute première version de l'article de Nellie, dactylographiée et agrafée. Le docteur Morrow y est explicitement cité (son nom a été changé dans l'article final publié).",
                              "label": "🔵 Indice n°12"
                        },
                        {
                              "type": "bleu",
                              "contenu": "🔵 Aide de jeu — Vous pouvez donner l'aide de jeu B (extrait de Ten Days in a Madhouse) à vos joueurs.",
                              "label": "🔵 Aide de jeu"
                        },
                        {
                              "type": "bleu",
                              "contenu": "Indice n°13 — Une liste de noms : deux feuilles manuscrites, patients hommes et femmes de l'aile expérimentale du docteur Morrow. Les PJ ont la surprise de constater qu'il s'agit de leurs propres noms — rayés par Nellie après les avoir fait libérer. Au dos : « FBI 09/1920 : attentat de Wall Street. Quel rapport avec Stemfield ? Pourquoi espionne-t-il Morrow ? Quel lien entre tous ces gens ? 42 Sterling Place. »",
                              "label": "🔵 Indice n°13"
                        },
                        {
                              "type": "bleu",
                              "contenu": "Indice n°14 — Des coupures de presse : une chemise en carton avec deux coupures et un ticket d'entrée au muséum d'Histoire naturelle daté du 20 décembre 1920.\nCoupure 1 : « 20 septembre 1915. Tragique accident de voiture à Brooklyn. » L'accident qui a coûté la vie à Harriet Morrow et plongé sa fille Margery dans un profond coma. Morrow est presque indemne.\nCoupure 2 : « 12 décembre 1918. Inauguration de l'exposition temporaire égyptienne au muséum d'Histoire naturelle de New York. Le Louvre de Paris prête une momie à New York pour trois ans. » Photo de quatre hommes en costume autour d'un sarcophage : Gaston Privesne, Malcolm Skripack (directeur du musée), Andrew Lesterneal (chaire d'ethnologie) et le docteur Morrow, décrit comme amateur d'archéologie et généreux donateur.",
                              "label": "🔵 Indice n°14"
                        }
                  ]
            },
            {
                  "titre": "14. Salle d'eau — chambre noire",
                  "blocs": [
                        {
                              "type": "neutre",
                              "contenu": "Nellie s'en sert comme chambre noire. Son appareil photo, un Vest Pocket Autographic Kodak, est encore posé sur le lavabo à côté d'un bac à réactif. Il y a une pellicule à l'intérieur."
                        },
                        {
                              "type": "bleu",
                              "contenu": "Un PJ journaliste (comme Ilia Droudji) réussit automatiquement à développer les photos. Pour les autres, il est possible de suivre la procédure expliquée dans un ouvrage de la bibliothèque.",
                              "label": "🔵 Jet de dés"
                        },
                        {
                              "type": "bleu",
                              "contenu": "Indice n°15 — Photos à développer (pellicule de 5 photos) :\nPhoto 1 : un champ de blé, des maisons au loin dont celle du docteur Stemfield (reflet du soleil sur une lunette d'observation). Autographiée du 20 octobre 1920.\nPhoto 2 : un individu qui sort d'un petit pavillon (même maison, façade opposée — test d'INT difficulté 15 pour le rapprochement). Les PJ reconnaissent Stemfield ! Autographiée « 42 Sterling Place ».\nPhotos 3 et 4 : la maison de Morrow. L'une autographiée « Albany Av. » ; sur l'autre, un homme à la peau foncée en livrée pousse une jeune femme en fauteuil roulant devant la maison.",
                              "label": "🔵 Indice n°15"
                        },
                        {
                              "type": "bleu",
                              "contenu": "Indice n°16 — La dernière photo de Nellie : sur le négatif, une cour vide (celle de la Villa Paterson) prise depuis la fenêtre de la cuisine. Mais une fois développée, un sujet central absent du négatif apparaît : une haute silhouette noire de dos, un individu grand et mince en long manteau noir et chapeau. Tandis que les PJ observent la photo, la silhouette s'estompe, devient grise et transparente, puis disparaît définitivement avant même que la photo ait fini de sécher — ne laissant que la cour vide. Le phénomène se reproduit deux fois, puis à la troisième tentative le négatif gondole et se consume, rendant la pellicule inutilisable.",
                              "label": "🔵 Indice n°16"
                        },
                        {
                              "type": "bleu",
                              "contenu": "[MJ SEULEMENT] Cette dernière photo est celle que Nellie a prise au moment où l'Homme en noir (Nyarlathotep) repartait de la Villa Paterson, juste avant que la maison ne se referme définitivement sur elle. Une expérience que les PJ partageront avec Nellie dans l'aventure 3.",
                              "label": "🔵 Secret MJ"
                        }
                  ]
            },
            {
                  "titre": "15. Toilettes et 16. Cave",
                  "blocs": [
                        {
                              "type": "neutre",
                              "contenu": "Des toilettes ordinaires, juste à côté de la salle d'eau."
                        },
                        {
                              "type": "vert",
                              "contenu": "Se trouvent ici des outils en tout genre : tournevis, marteau, scie, etc. La cave sert aussi de cellier : plusieurs cagettes de pommes et de pommes de terre pour l'hiver. De la farine est stockée hors de portée des souris dans une caisse de fer, et une étagère supporte quelques boîtes de conserve (corned beef)."
                        },
                        {
                              "type": "neutre",
                              "contenu": "[MJ — clin d'œil] Si vous avez joué Septembre rouge, ajoutez une boîte de homard de Lobster Island !"
                        }
                  ]
            },
            {
                  "titre": "Transition vers la suite",
                  "blocs": [
                        {
                              "type": "neutre",
                              "contenu": "Les PJ disposent de plusieurs pistes qui vont les mener désormais à Amityville (asile, maisons de Stemfield et Morrow), mais aussi dans les Contrées du rêve et au musée d'Archéologie de New York. La suite est ouverte et dépend de leurs choix."
                        },
                        {
                              "type": "bleu",
                              "contenu": "[MJ SEULEMENT] La suite de cette première aventure est étroitement imbriquée avec l'aventure 2, laquelle débute dès que les PJ pénètrent dans les Contrées du rêve — c'est-à-dire lors du flash-back de l'asile psychiatrique au milieu de l'aventure 1. Le passage dans les Contrées du rêve ne signifie pas que l'aventure 1 est terminée : gérez les allers-retours entre les deux mondes jusqu'à la conclusion des deux premières aventures. L'aventure 1 ne sera complètement achevée que lorsque les PJ auront vécu : le flash-back à la maison du docteur Stemfield, le flash-back à l'asile et le premier voyage dans les Contrées du rêve, la découverte du plan de Nyarlathotep, et le recueil des équations d'Alexeï Fedorov transmises à Einstein.",
                              "label": "🔵 Conseil MJ"
                        }
                  ]
            }
      ...
      "pnj": [
            {
                  "nom": "Nellie Bly (absente)",
                  "desc": "Ancienne occupante de cette chambre, infiltrée à l'asile sous le nom de Betty Cott. A pris la dernière photo de l'Homme en noir avant de disparaître."
            },
            {
                  "nom": "Docteur Morrow",
                  "desc": "Dirige l'aile expérimentale de l'asile. Généreux donateur du muséum, amateur d'archéologie. Sa fille Margery est dans le coma depuis 1915."
            }
      ]
},
    {
      ...
      "resume": "L'un des ouvrages de la bibliothèque de la villa mène directement au American Museum of Natural History, où est exposé depuis décembre 1918 le sarcophage de Rahotep — le prêtre associé à William Morrow.",
      "chapitres": [
            {
                  "titre": "L'inventaire de Gaston Privesne",
                  "blocs": [
                        {
                              "type": "neutre",
                              "contenu": "Le dernier ouvrage de la bibliothèque de la Villa Paterson (édité en octobre 1920) fait l'inventaire des découvertes de Gaston Privesne, archéologue français qui a découvert un tombeau en Égypte en février 1918 : cinq sarcophages d'une période très ancienne, ainsi que des centaines de momies de chat."
                        },
                        {
                              "type": "bleu",
                              "contenu": "Indice n°7 — Inventaire du tombeau aux cinq sarcophages : une coupure de presse marque la page consacrée à l'exposition temporaire à New York (décembre 1918 à décembre 1921, American Museum of Natural History). Une photo montre Gaston Privesne et le sarcophage. Les pages suivantes reproduisent les cartouches gravés sur les cinq sarcophages et leur traduction.",
                              "label": "🔵 Indice n°7"
                        },
                        {
                              "type": "vert",
                              "contenu": "« Tohtesis, ta carnation aura une couleur dorée grâce à l'orpiment pur, émanation de Rê, pour l'éternité ! Car, pour toi, il mettra de l'or sur tes chairs, une couleur parfaite sur les extrémités de tes membres, et ton cœur sera prélevé et remplacé par le scarabée d'or pour ton âme immortelle. Quand il aura rendu ton teint florissant grâce à l'or et rendu tes chairs inaltérables grâce à l'électrum, tu seras vivant, pour toujours et à jamais, tu seras rajeuni, pour toujours et à jamais. Et tu pourras servir au-delà des ténèbres, pour toujours et à jamais. »"
                        },
                        {
                              "type": "neutre",
                              "contenu": "Les quatre autres cartouches reproduisent la même litanie, seuls changent le nom et le symbole associé :\n• Tohtesis — Scarabée d'or\n• Rahotep — Croissant d'argent (il s'agit de Morrow)\n• Pannekhop — Tortue volante\n• Ptahsiris — Bœuf Apis\n• Oumhotep — Chenille rampante"
                        },
                        {
                              "type": "neutre",
                              "contenu": "Un trait au crayon entoure le cartouche Rahotep – Croissant d'argent. C'est Nellie Bly qui l'a fait après avoir constaté qu'il s'agissait du sarcophage exposé au muséum d'Histoire naturelle."
                        },
                        {
                              "type": "bleu",
                              "contenu": "[MJ SEULEMENT] Si un PJ est lui-même égyptologue, ne fournissez pas la traduction — c'est le moment pour lui de briller. Sinon, cela dirige naturellement les PJ vers le musée pour trouver un traducteur compétent.",
                              "label": "🔵 Conseil MJ"
                        }
                  ]
            },
            {
                  "titre": "American Museum of Natural History",
                  "type": "lieu"
            },
            {
                  "titre": "L'exposition égyptienne",
                  "blocs": [
                        {
                              "type": "vert",
                              "contenu": "Le musée abrite depuis décembre 1918 une collection d'objets égyptiens d'une qualité exceptionnelle, prêtée par la France pour trois années complètes. En son cœur, le sarcophage de Rahotep, dont le cartouche est identique à celui trouvé dans les livres de la Villa Paterson — décoré d'un croissant d'argent."
                        },
                        {
                              "type": "neutre",
                              "contenu": "L'inauguration de cette exposition, le 12 décembre 1918, réunissait Gaston Privesne, Malcolm Skripack (directeur du musée), Andrew Lesterneal (chaire d'ethnologie) et le docteur Morrow lui-même, décrit à l'époque comme amateur d'archéologie et généreux donateur — comme le révèle la coupure de presse trouvée dans la chambre de Nellie."
                        },
                        {
                              "type": "bleu",
                              "contenu": "[MJ SEULEMENT] C'est ici que l'esprit du prêtre Rahotep a pris possession du corps de William Morrow, présent à l'inauguration en décembre 1918.",
                              "label": "🔵 Secret MJ"
                        }
                  ]
            }
      ...
      "pnj": [
            {
                  "nom": "Gaston Privesne",
                  "desc": "Archéologue français, découvreur du tombeau aux cinq sarcophages en février 1918. Absent du musée à ce stade de l'enquête — il réapparaîtra plus tard dans la campagne."
            }
      ]
}
  ],
